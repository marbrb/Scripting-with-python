...
#SMTP es un protocolo de texto que es usado comunmente para el envio de correos electronicos
#Cuando es implementado el servidor puede interpretar una seria de comandos que envie el cliente
#Description: Script para determinar la existencia de usuarios en el servidor
